...
success rates for predicting system behavior are still surprisingly low (around 60%). The authors address
...
Link: [Paper](https://dl.acm.org/doi/10.1145/3301275.3302289)
...
conduct an experiment using the [QuickDraw](http://quickdraw.withgoogle.com)
...
[PRISMA](http://prisma-statement.org/) framework (primarily, I've seen it in 
...
the [Ethically Aligned Design](https://standards.ieee.org/content/dam/ieee-standards/standards/web/documents/other/ead_v2.pdf)
...
This very helpful blog post revisits a [2015 NeurIPS paper](https://papers.nips.cc/paper/5656-hidden-technical-debt-in-machine-learning-systems.pdf)
